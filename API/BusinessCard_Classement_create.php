  ...
  if (isset($_POST['token']))
  {
    ...
    if ($pos >= 0)
    {
      ...
      if ( $num_rows > 0 )      
      {
        ...
        $sql = "delete from businesscard_classement where idutilisateur = ".$idUser." and idbusinesscard = ".$_POST['idBusinessCard']   ;
        if (isset($_POST['debug']))
          echo $sql."\n" ;
        ...
        $sql = "insert into businesscard_classement( idutilisateur,  idbusinesscard, idcategorie ) values (".$idUser.",".$_POST['idBusinessCard'].",".$_POST['idCategorie'].")" ;
        ...
        if($result !== false)
          ...
          echo "ERROR: Classification not saved" ;
