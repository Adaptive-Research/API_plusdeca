    ...
    if ($pos >= 0)
    {
      ...
      if ( $num_rows > 0 )
      {
        if (isset($_POST['idAncestor']))
          $sql = "update articles set isvalidated = 0 where idancestor = ".$_POST['idAncestor']." and numversion = ".$_POST['NumVersion']   ;
        else 
          $sql = "update articles set isvalidated = 0 where id = ".$_POST['id']   ;
        ...
        if($result !== false)
          ...
          echo "ERROR: Article not invalidated" ;
      }
      else
