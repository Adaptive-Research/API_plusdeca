    ...
    if ($pos >= 0)
    {
      ...
      if ( $num_rows > 0 )
      {
        if (isset($_POST['idAncestor']))
          $sql = "update formations set isvalidated = 0 where idancestor = ".$_POST['idAncestor']." and numversion = ".$_POST['NumVersion']   ;
        else 
          $sql = "update formations set isvalidated = 0 where id = ".$_POST['id']   ;
        ...
        if($result !== false)
          ...
          echo "ERROR: Formation not invalidated" ;
      }
      else
